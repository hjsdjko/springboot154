 ...
 */
@TableName("yuyuejieguo")
public class YuyuejieguoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YuyuejieguoEntity() {
		
	}
	
	public YuyuejieguoEntity(T t) {
		try {
	...
	private String jiashiyuanquerenzhuangtai;
	 ...
	 * 设置：驾驶员确认状态
	 */
	public void setJiashiyuanquerenzhuangtai(String jiashiyuanquerenzhuangtai) {
		this.jiashiyuanquerenzhuangtai = jiashiyuanquerenzhuangtai;
	}
	/**
	 * 获取：驾驶员确认状态
	 */
	public String getJiashiyuanquerenzhuangtai() {
		return jiashiyuanquerenzhuangtai;
	}
