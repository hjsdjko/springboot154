...
public class JiashiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiashiyuanEntity u = jiashiyuanService.selectOne(new EntityWrapper<JiashiyuanEntity>().eq("jiashiyuanzhanghao", username));
        if(u==null || !u.getJiashiyuanmima().equals(password)) {
    ...
    public R register(@RequestBody JiashiyuanEntity jiashiyuan){
    	...
    	JiashiyuanEntity u = jiashiyuanService.selectOne(new EntityWrapper<JiashiyuanEntity>().eq("jiashiyuanzhanghao", jiashiyuan.getJiashiyuanzhanghao()));
		if(u!=null) {
    ...
    public R info(@PathVariable("id") Long id){
		...
		jiashiyuan = jiashiyuanService.selectView(new EntityWrapper<JiashiyuanEntity>().eq("id", id));
